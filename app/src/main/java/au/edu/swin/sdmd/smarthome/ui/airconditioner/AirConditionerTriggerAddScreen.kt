...
@Composable
fun AirConditionerTriggerAddScreen(
    navigateBack: () -> Unit,
    viewModel: AirConditionerTriggerAddViewModel = viewModel(factory = SmartHomeViewModelFactory)
) {
    ...
    Column(
        ...
        Button(
            ...
            Text(
                text = stringResource(id = R.string.create_trigger)
            )
        }
    }
}
