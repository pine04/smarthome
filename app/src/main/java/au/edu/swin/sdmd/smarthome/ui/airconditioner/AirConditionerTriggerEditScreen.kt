...
@Composable
fun AirConditionerTriggerEditScreen(
    navigateBack: () -> Unit,
    viewModel: AirConditionerTriggerEditViewModel = viewModel(factory = SmartHomeViewModelFactory)
) {
    Log.d("EDIT_SCREEN", viewModel.uiState.toString())
    ...
    Column(
        ...
        ExposedDropdownMenuBox(
            ...
            TextField(
                readOnly = true,
                value = stringResource(id = airConditionerActionToStringResource(triggerDetails.triggerAction)),
                onValueChange = { },
            ...
            ExposedDropdownMenu(
                ...
                AirConditionerAction.entries.map { option ->
                    DropdownMenuItem(
                        text = { Text(text = stringResource(id = airConditionerActionToStringResource(option))) },
                        onClick = {
                            viewModel.updateAirConditionerTriggerDetails(triggerDetails.copy(triggerAction = option))
        ...
        MaterialDialog(
            ...
            buttons = {
                positiveButton(text = stringResource(id = R.string.set)) {
                    viewModel.updateAirConditionerTriggerDetails(triggerDetails.copy(triggerTime = pickedTime))
                }
